...
void DriveF(){
        RL.spin(vex::directionType::fwd,33,vex::velocityUnits::pct);
        RR.spin(vex::directionType::fwd,33,vex::velocityUnits::pct);
        FR.spin(vex::directionType::fwd,33,vex::velocityUnits::pct);
        FL.spin(vex::directionType::fwd,33,vex::velocityUnits::pct);
}
void DriveFast(){
...
void TurnLeft(){
        RL.spin(vex::directionType::rev,127,vex::velocityUnits::rpm);
        RR.spin(vex::directionType::fwd,127,vex::velocityUnits::rpm);
        FR.spin(vex::directionType::fwd,127,vex::velocityUnits::rpm);
        FL.spin(vex::directionType::rev,127,vex::velocityUnits::rpm);
}
void StrafeR(){
   ...
   DriveStop();
    ...
    DriveStop();
     ...
     Arm.spin(vex::directionType::fwd,7,vex::velocityUnits::pct);
      Stacker.rotateFor(1250,rotationUnits::deg,50, vex::velocityUnits::pct);
