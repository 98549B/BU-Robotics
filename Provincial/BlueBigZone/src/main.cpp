...
void StrafeL(){
        RL.spin(vex::directionType::fwd,80,vex::velocityUnits::pct);
        RR.spin(vex::directionType::rev,80,vex::velocityUnits::pct);
        FR.spin(vex::directionType::fwd,80,vex::velocityUnits::pct);
        FL.spin(vex::directionType::rev,80,vex::velocityUnits::pct);
}
void DriveStop(){
