...
void DriveBSS(){
        RL.spin(vex::directionType::rev,20,vex::velocityUnits::pct);
        RR.spin(vex::directionType::rev,20,vex::velocityUnits::pct);
        FR.spin(vex::directionType::rev,20,vex::velocityUnits::pct);
        FL.spin(vex::directionType::rev,20,vex::velocityUnits::pct);
}
void DriveFS(){
        RL.spin(vex::directionType::fwd,30,vex::velocityUnits::pct);
        RR.spin(vex::directionType::fwd,30,vex::velocityUnits::pct);
        FR.spin(vex::directionType::fwd,30,vex::velocityUnits::pct);
...
void DriveFast(){
        RL.spin(vex::directionType::fwd,55,vex::velocityUnits::pct);
        RR.spin(vex::directionType::fwd,55,vex::velocityUnits::pct);
        FR.spin(vex::directionType::fwd,55,vex::velocityUnits::pct);
        FL.spin(vex::directionType::fwd,55,vex::velocityUnits::pct);
}
void DriveB(){
...
void TurnRight(){
        RL.spin(vex::directionType::fwd,70,vex::velocityUnits::pct);
        RR.spin(vex::directionType::rev,70,vex::velocityUnits::pct);
        FR.spin(vex::directionType::rev,70,vex::velocityUnits::pct);
        FL.spin(vex::directionType::fwd,70,vex::velocityUnits::pct);
}
void TurnLeft(){
        RL.spin(vex::directionType::rev,200,vex::velocityUnits::rpm);
        RR.spin(vex::directionType::fwd,200,vex::velocityUnits::rpm);
        FR.spin(vex::directionType::fwd,200,vex::velocityUnits::rpm);
        FL.spin(vex::directionType::rev,200,vex::velocityUnits::rpm);
}
void StrafeR(){
...
void StrafeL(){
        RL.spin(vex::directionType::fwd,90,vex::velocityUnits::pct);
        RR.spin(vex::directionType::rev,90,vex::velocityUnits::pct);
...
void RollerIntakeF(){
        Roller1.spin(vex::directionType::rev,100 , vex::percentUnits::pct);
        Roller2.spin(vex::directionType::fwd,100, vex::percentUnits::pct);
}
void RollerIntakeS(){
...
void turnR (double degrees_to_rotate){
    
    double current_deg = Inert1.yaw();

    
    while (current_deg < degrees_to_rotate){
        current_deg = Inert1.yaw();
...
void turnL (double degrees_to_rotate){
...
task::sleep(200);
   ...
   Arm.resetRotation();
   Arm.rotateFor(-470,rotationUnits::deg,90, vex::velocityUnits::pct);
   //SonarMoveFS(600);
   DriveF();
   task::sleep(320);
   DriveStop();
...
Arm.spin(vex::directionType::fwd,3, vex::velocityUnits::pct);
   DriveFS(); 
    RollerIntakeF();
    task::sleep(260);
    DriveStop();
...
Stacker.rotateFor(1150,rotationUnits::deg,127, vex::velocityUnits::pct);
Stacker.rotateFor(1600,rotationUnits::deg,40, vex::velocityUnits::pct);
/*
StrafeL();
task::sleep(2400);
DriveStop();
...
//Controller1.Screen.setCursor(1,2);
   // Controller1.Screen.print(Arm.value());
...
if ((Stacker.rotation(rotationUnits::deg))>=1800){
  Arm.spin(vex::directionType::fwd,1, vex::velocityUnits::pct);
 Stacker.spin(vex::directionType::fwd, 40, vex::velocityUnits::pct);
}


if ((Stacker.rotation(rotationUnits::deg))>=2785){
